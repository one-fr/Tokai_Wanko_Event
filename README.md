...
東海4県（愛知・岐阜・三重・静岡）で開催される犬メインのイベント・マルシェ（例: わんにゃんドーム、犬市場 等）の開催情報を毎月自動収集し、専用のGoogleカレンダーに登録するシステムです。
...
- **東海4県外の例外**: 「インターペット」（東京ビッグサイト／インテックス大阪）のみ対象に含めます。他の東京・大阪のイベントは対象外です
